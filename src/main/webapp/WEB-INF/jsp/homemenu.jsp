...
<div id="tour" class="bg-1">
  <div class="container">
    <h3 class="text-center">Our contribution to the world</h3>
    <p class="text-center">We want to make the world a better place.<br> What you want to do for the society!</p>
