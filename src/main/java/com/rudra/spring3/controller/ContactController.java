...
public class ContactController {
    ...
    public ModelAndView showWelcome(ModelMap model, Principal principal) {
        ...
        carousel2.setImageAlt("Los Angeles");
        carousel2.setHeading("Rebuilding the village economy");
        ...
        carousel3.setImageAlt("Chicago");
        carousel3.setHeading("Children Education");
